...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_permission_add('添加课时节点','{{ url('admin/lesson/add') }}','','360')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加课时节点</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="100">预览视频</th>
				<th width="100">播放时间/s</th>
				<th width="100">状态</th>
				<th width="100">创建于</th>
				<th width="100">更新于</th>
				<th width="100">操作</th>
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{ $lesson->course->teacher}}</td>
				<td>{{ $lesson->lesson_name }}</td>
				<td>
					{{--<input class="btn btn-primary radius" type="button" value="播放">--}}
					<button class="btn btn-primary radius" onclick="layer_show('播放视频','{{ url('admin/lesson/play', [$lesson->id]) }}', '', 500)">
						<i class="Hui-iconfont Hui-iconfont-bofang"></i>播放
					</button>
				</td>
				<td>{{ $lesson->video_time }}</td>
