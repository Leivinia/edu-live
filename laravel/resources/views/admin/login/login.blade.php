...
<![endif]-->
<link href="{{ asset('style/admin/static') }}/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="{{ asset('style/admin/static') }}/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
<link href="{{ asset('style/admin/static') }}/h-ui.admin/css/style.css" rel="stylesheet" type="text/css" />
<link href="{{ asset('style/admin/lib') }}/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
    ...
    <form class="form form-horizontal" action="{{ url('admin/login') }}" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="{{captcha_src()}}" id="captcha" onclick="changeCaptcha()">
             <a id="kanbuq" href="javascript:;" onclick="changeCaptcha()">看不清，换一张</a> 
          </div>
          <script>
          function changeCaptcha() {
            var captchaObj = document.getElementById('captcha')
            captchaObj.src = "{{captcha_src()}}" + (new Date()).getTime()
          }
          </script>
      </div>
      <div class="row cl">
