...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管理员管理 <span
            class="c-gray en">&gt;</span> 课程管理 <a class="btn btn-success radius r"
...
<div class="page-container">
    <div class="text-c">
        <form class="Huiform" method="post" action="" target="_self">
            ...
            <button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜课程节点
            </button>
        </form>
    </div>
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
                    ...
                    href="javascript:;"
                    onclick="admin_permission_add('添加课程节点','{{ url('admin/course/add') }}','','500')"
                    class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加课程节点</a></span> <span
            ...
            <tr class="text-c">
                ...
                <td>
                    @if($admin->sex==1)
                        ...
                        <font color="#8b0000">女</font>@endif
                </td>
                <td>
                    @if($admin->state)
                        <font color="blue">启用</font>
                        <font color="#8b0000">禁用</font>@endif
                </td>
