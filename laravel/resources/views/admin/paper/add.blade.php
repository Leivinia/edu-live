    ...
    <form class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" name="paper_name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>总分：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="" name="score">
            </div>
        </div>
        <div class="row cl">
            ...
            submitHandler: function (form) {
                ...
                $(form).ajaxSubmit({
                    ...
                    success: function (data) {
                        ...
                        setTimeout(function () {
                            parent.window.location.href = "{{url('admin/paper/index')}}"
                        }, 2000)
                    },
